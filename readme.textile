...
<pre>
Hyperpublic.places.find(your_query, your_callback);
</pre>
...
<pre>
Hyperpubic.places.show(4, 'callback');
</pre>
...
<pre>
Hyperpublic.places.find({ "location" : "New York, NY 10014", "q":"pizza", "limit": "2"}, 'callback');
</pre>
