...
h3. Intertacting with the Hyperpublic API
...
p. Its very easy to search the Hyperpublic by sending a series of paramaters to the API. If I wanted to find 2 developers in Chelsea, I would issue a query like this:
